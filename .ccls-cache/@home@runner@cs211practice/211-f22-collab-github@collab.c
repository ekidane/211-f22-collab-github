...
void enaka2_jmart397() {
  printf("Ethan Nakashima and a Jovany Martinez\n");
  printf("We learned that Github makes it easy for developers to share code files and collaborate with developers on projects. Using Git is useful at tracking the changes and updates of a repository. \n");
}
